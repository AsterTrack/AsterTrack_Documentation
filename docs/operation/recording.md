...
Here, you can record individual sections or the entire past session (as long as it is still in memory).
From the list of recorded sections, you can save them to disk as two json files: <br>
