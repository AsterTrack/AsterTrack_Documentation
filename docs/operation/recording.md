...
From there, you can save them to disk as two json files: <br>
...
Appending similar captures is intended to aggregate samples of a session to improve camera calibration in post, and appending separate captures is intended to aggregate samples from a longer time period to improving target calibration. <br>
